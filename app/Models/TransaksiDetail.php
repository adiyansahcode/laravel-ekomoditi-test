...
class TransaksiDetail extends Model
{
    ...
    protected static function booted()
    {
        ...
        static::creating(function (TransaksiDetail $data) {
        ...
        static::updating(function (TransaksiDetail $data) {
            if (auth()->user()) {
                $data->updated_by = auth()->user()->id;
            }
        });
        ...
        static::deleted(function (TransaksiDetail $data) {
            if (auth()->user()) {
    ...
    /**
     * relation to table KriteriaBuah
     *
     * @return object
     */
    public function kriteriaBuah(): object
    {
        return $this->belongsTo(KriteriaBuah::class, 'kriteria_buah_id');
    }
}
